...
このファイルは Codex がこのリポジトリで作業する際の標準ルールを定義する。
作業を始める前に必ず読むこと。
...
- Codex が安定して開発を継続できるよう、軽量な標準ハーネスを備える。
- 開発方針:
...
- 実装チェックリスト: [.Codex/harness/implementation-checklist.md](.Codex/harness/implementation-checklist.md)
- レビューチェックリスト: [.Codex/harness/review-checklist.md](.Codex/harness/review-checklist.md)
- セキュリティチェックリスト: [.Codex/harness/security-checklist.md](.Codex/harness/security-checklist.md)
